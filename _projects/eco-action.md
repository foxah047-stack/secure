...
sections:
  ...
  - type: steps
    ...
    title_fr: De l’observation à l’infiltration
    title_en: From observation to infiltration
    intro_fr: Les interventions sont conçues à partir des conditions observées sur le terrain, afin de retenir l’eau plus longtemps dans le paysage tout en réduisant l’érosion et les apports au ruisseau.
    intro_en: Measures are designed from field conditions to retain water longer in the landscape while reducing erosion and inputs to the creek.
    steps:
      - title_fr: Comprendre les écoulements
  ...
  - type: text
    ...
    kicker_en: Expected results
    title_fr: Des démonstrateurs pour la communauté
    title_en: Demonstration sites for the community
    body_fr: |
      Les aménagements pilotes visent à améliorer la qualité de l’eau en limitant les apports de sédiments et de nutriments, à réduire l’érosion et à favoriser la recharge des eaux souterraines. Ils contribueront aussi à mieux comprendre quelles solutions conviennent aux conditions locales du bassin versant.

      Le projet comprend une campagne de communication, des occasions d’apprentissage sur le terrain et des activités de mobilisation auprès des résidents, des producteurs agricoles, de la municipalité et des écoles. Le suivi des données de référence et des aménagements accompagnera cette démarche jusqu’en 2027.
    body_en: |
